...
// Component specs for the palette-opened delete-confirm step and revert picker.
...
describe("ConfirmDeleteMenu", () => {
  it("Given the confirm-delete step, then it warns and offers y/n", async () => {
    const frame = await frameOf(<ConfirmDeleteMenu title="Doomed" />);
