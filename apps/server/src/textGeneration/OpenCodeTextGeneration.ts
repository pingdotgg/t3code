...
export const makeOpenCodeTextGeneration = Effect.fn("makeOpenCodeTextGeneration")(function* (
  ...
  const resolveMergeConflict: TextGeneration.TextGeneration["Service"]["resolveMergeConflict"] = Effect.fn(
  ...
  const verifyMergeResolution: TextGeneration.TextGeneration["Service"]["verifyMergeResolution"] = Effect.fn(
