...
/**
 * Text generation over a throwaway `kiro-cli acp` session. The agent starts
 * with no trusted tools and no permission handler, so any tool call it
 * attempts is rejected and the reply stays text-only.
 */
