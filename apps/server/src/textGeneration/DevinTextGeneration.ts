 ...
 * payload. Mirrors the Cursor/Codex text-generation flow over ACP.
 */
            ...
            new TextGenerationError({
              ...
              detail:
                step === "set-config-option"
                  ? `Failed to set Devin ACP config option "${configId ?? "reasoning"}" for text generation.`
                  : "Failed to set Devin ACP base model for text generation.",
              cause,
            }),
        });
          ...
          Option.match({
            onNone: () =>
              Effect.fail(
                new TextGenerationError({
                  operation,
                  detail: "Devin Agent request timed out.",
                }),
              ),
