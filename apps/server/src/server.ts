...
import * as WorktreeTeardownReactor from "./orchestration/WorktreeTeardownReactor.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(WorktreeTeardownReactor.layer.pipe(Layer.provide(ProcessRunner.layer))),
