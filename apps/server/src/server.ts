...
import { makeGrokAdapterLive } from "./provider/Layers/GrokAdapter.ts";
...
import { TurnQueueReactorLive } from "./orchestration/Layers/TurnQueueReactor.ts";
...
import { ProjectAgentInventoryLive } from "./project/Layers/ProjectAgentInventory.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(TurnQueueReactorLive),
...
const RuntimeDependenciesLive = ReactorLayerLive.pipe(
  ...
  Layer.provideMerge(PreviewManagerLive.pipe(Layer.provide(OrchestrationLayerLive))),
