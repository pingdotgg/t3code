...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.agentSessionsImportAll]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentSessionsStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.agentSessionsSubscribeStatus]: AuthOrchestrationReadScope,
