...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerAuthAttach]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerAuthWrite]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerAuthResize]: AuthOrchestrationOperateScope,
