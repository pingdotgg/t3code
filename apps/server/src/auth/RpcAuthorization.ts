...
export const RPC_REQUIRED_SCOPES = {
  [WS_METHODS.controlPing]: AuthOrchestrationReadScope,
  [WS_METHODS.controlRequestStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.controlSendText]: AuthOrchestrationOperateScope,
