...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.extensionsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.extensionsInstall]: AuthOrchestrationOperateScope,
  [WS_METHODS.extensionsUninstall]: AuthOrchestrationOperateScope,
  [WS_METHODS.extensionsSetEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.extensionsConnect]: AuthOrchestrationOperateScope,
