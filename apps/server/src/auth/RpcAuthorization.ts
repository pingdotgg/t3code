...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.pluginsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsSetEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsAddSource]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsUpdateSource]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsRemoveSource]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginsCreateViewUrl]: AuthOrchestrationReadScope,
