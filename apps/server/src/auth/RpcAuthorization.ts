...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetCursorUsageStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSyncCursorUsage]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverGetCursorUsageEvents]: AuthOrchestrationReadScope,
  [WS_METHODS.serverExportCursorUsageCsv]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSetCursorUsageAdminApiKey]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSetCursorUsageSessionToken]: AuthOrchestrationOperateScope,
