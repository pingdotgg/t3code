import { makeAssistantEventDelivery } from "./assistantStreaming.ts";
    ...
    return RunExecutionServiceV2.of({
      startRootRun: (input) =>
        Effect.gen(function* () {
          ...
          const prepareAssistantEvent = makeAssistantEventDelivery(responseStreamingMode);
          ...
          const providerEventFiber = yield* eventSubscription.events.pipe(
            ...
            Stream.tap((event) =>
              Effect.gen(function* () {
                ...
                const deliveryEvent = prepareAssistantEvent(event);
                ...
                yield* trackChildLifecycle(event, deliveryEvent !== undefined);
              }),
            ),
