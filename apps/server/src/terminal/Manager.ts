...
// The tmux, GNU screen, and Zellij variables describe the multiplexer pane that
// launched the server, not the PTY, so inheriting them makes multiplexer-aware
// tools act on that unrelated pane.
