...
import { GitCommandError, type GitBranch } from "@forma/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@forma/shared/git";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `forma-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
