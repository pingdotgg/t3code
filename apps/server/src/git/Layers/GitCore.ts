...
import { GitCommandError, type GitBranch } from "@harness/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@harness/shared/git";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `harness-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
