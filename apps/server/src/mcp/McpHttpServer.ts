...
import { OperatorToolkitHandlersLive } from "./toolkits/operator/handlers.ts";
...
export const OperatorToolkitRegistrationLive = McpServer.toolkit(OperatorToolkit).pipe(
  Layer.provide(OperatorToolkitHandlersLive),
);
