    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_projects (
          ...
          scripts_json,
          cached_provider_slash_commands_json,
          created_at,
          updated_at,
          deleted_at
        )
        VALUES (
          ...
          ${row.cachedProviderSlashCommandsJson},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.deletedAt}
        )
        ...
        DO UPDATE SET
          ...
          cached_provider_slash_commands_json = excluded.cached_provider_slash_commands_json,
