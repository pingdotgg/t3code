...
import Migration0034 from "./Migrations/034_OrchestrationV2.ts";
import Migration0035 from "./Migrations/035_OrchestrationV2Subagents.ts";
import Migration0036 from "./Migrations/036_OrchestrationV2Foundation.ts";
import Migration0037 from "./Migrations/037_OrchestrationV2ProviderSessionBindings.ts";
import Migration0038 from "./Migrations/038_OrchestrationV2ThreadLaunchWorkflows.ts";
import Migration0039 from "./Migrations/039_ApplicationEventSource.ts";
import Migration0040 from "./Migrations/040_OrchestrationV2EffectCancellation.ts";
import Migration0041 from "./Migrations/041_ScheduledTasks.ts";
import Migration0042 from "./Migrations/042_LegacyV1ImportState.ts";
...
export const migrationEntries = [
  ...
  [34, "OrchestrationV2", Migration0034],
  [35, "OrchestrationV2Subagents", Migration0035],
  [36, "OrchestrationV2Foundation", Migration0036],
  [37, "OrchestrationV2ProviderSessionBindings", Migration0037],
  [38, "OrchestrationV2ThreadLaunchWorkflows", Migration0038],
  [39, "ApplicationEventSource", Migration0039],
  [40, "OrchestrationV2EffectCancellation", Migration0040],
  [41, "ScheduledTasks", Migration0041],
  [42, "LegacyV1ImportState", Migration0042],
] as const;
