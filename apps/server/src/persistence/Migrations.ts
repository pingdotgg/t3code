...
import Migration0041 from "./Migrations/041_ProjectionSyncedClientPreferences.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadSessionProviderLifecycle.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionSyncedClientPreferences", Migration0041],
  [42, "ProjectionThreadSessionProviderLifecycle", Migration0042],
] as const;
