...
import Migration0042 from "./Migrations/042_ProjectionThreadSessionStatusDetail.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadSessionCompactingSince.ts";
...
export const migrationEntries = [
  ...
  [42, "ProjectionThreadSessionStatusDetail", Migration0042],
  [43, "ProjectionThreadSessionCompactingSince", Migration0043],
] as const;
