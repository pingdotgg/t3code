...
import Migration0042 from "./Migrations/042_ForkProjectionCompatibility.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadMessagePhase.ts";
...
export const migrationEntries = [
  ...
  [42, "ForkProjectionCompatibility", Migration0042],
  [43, "ProjectionThreadMessagePhase", Migration0043],
] as const;
