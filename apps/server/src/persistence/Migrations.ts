...
import Migration0033 from "./Migrations/033_ProjectionThreadsBookmarkAndPullRequest.ts";
import Migration0034 from "./Migrations/034_ProjectionThreadsForkedFrom.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadsBookmarkAndPullRequest", Migration0033],
  [34, "ProjectionThreadsForkedFrom", Migration0034],
] as const;
