...
import Migration0052 from "./Migrations/052_ProjectionTasks.ts";
import Migration0053 from "./Migrations/053_ProjectionThreadTaskMembership.ts";
import Migration0054 from "./Migrations/054_ThreadTaskSettlementRestore.ts";
...
const migrationEntries = [
  ...
  [52, "ProjectionTasks", Migration0052],
  [53, "ProjectionThreadTaskMembership", Migration0053],
  [54, "ThreadTaskSettlementRestore", Migration0054],
] as const;
