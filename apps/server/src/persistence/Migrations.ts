...
import Migration0041 from "./Migrations/041_ProjectionThreadsOperator.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadsOperatorWait.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsOperator", Migration0041],
  [42, "ProjectionThreadsOperatorWait", Migration0042],
] as const;
