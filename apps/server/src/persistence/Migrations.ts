...
import Migration0041 from "./Migrations/041_ProjectionTurnRequestSequence.ts";
import Migration0042 from "./Migrations/042_ProjectionTurnDeliverySequence.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionTurnRequestSequence", Migration0041],
  [42, "ProjectionTurnDeliverySequence", Migration0042],
] as const;
