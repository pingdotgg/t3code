...
import Migration0038 from "./Migrations/038_ProjectionProjectsAdditionalFolders.ts";
import Migration0039 from "./Migrations/039_ProjectionTurnsSourceProposedPlanKind.ts";
...
export const migrationEntries = [
  ...
  [38, "ProjectionProjectsAdditionalFolders", Migration0038],
  [39, "ProjectionTurnsSourceProposedPlanKind", Migration0039],
] as const;
