...
import Migration0041 from "./Migrations/041_ProjectionThreadUserInputLifecycleIndex.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadShellSummaryState.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadUserInputLifecycleIndex", Migration0041],
  [42, "ProjectionThreadShellSummaryState", Migration0042],
] as const;
