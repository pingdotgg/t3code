...
export interface ProjectionTurnRepositoryShape {
  ...
  /**
   * Stores a pending-start placeholder row for a thread.
   */
  ...
  /**
   * Deletes the oldest pending-start placeholder row for a thread and leaves concrete turn rows untouched.
   */
