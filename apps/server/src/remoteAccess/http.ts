...
import * as ServerAdvertisedEndpoints from "./ServerAdvertisedEndpoints.ts";
...
export const remoteAccessHttpApiLayer = HttpApiBuilder.group(
  ...
  Effect.fnUntraced(function* (handlers) {
    const advertisedEndpoints = yield* ServerAdvertisedEndpoints.ServerAdvertisedEndpoints;
