import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@harness/contracts";
...
import { KeybindingsConfigError } from "@harness/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "harness-keybindings-test-",
        }),
      ),
    ),
  );
