  ...
  it.effect("falls back to effect/config values when flags are omitted", () =>
    Effect.gen(function* () {
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  T3CODE_PORT: "4001",
                  T3CODE_HOST: "0.0.0.0",
                  T3CODE_ENVIRONMENT_LABEL: " Build Farm 03 ",
                  T3CODE_HOME: baseDir,
      ...
      expect(resolved).toEqual({
        ...
        ...derivedPaths,
        host: "0.0.0.0",
        environmentLabel: "Build Farm 03",
        staticDir: undefined,
      ...
      const resolved = yield* resolveServerConfig(
        {
          ...
          environmentLabel: Option.some("Flag Label"),
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  T3CODE_PORT: "4001",
                  T3CODE_HOST: "0.0.0.0",
                  T3CODE_ENVIRONMENT_LABEL: "Env Label",
