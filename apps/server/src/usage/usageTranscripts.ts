...
/**
 * Splits cache creation into five-minute and one-hour writes, clamped so the
 * TTL counters never exceed the aggregate. The remainder is unclassified.
 */
export function cacheCreationSplit(totals: UsageTokenTotals): {
