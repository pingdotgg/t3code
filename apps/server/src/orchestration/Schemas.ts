import {
  ...
  ThreadSidebarStateUpdatedPayload as ContractsThreadSidebarStateUpdatedPayloadSchema,
...
export const ThreadSidebarStateUpdatedPayload = ContractsThreadSidebarStateUpdatedPayloadSchema;
