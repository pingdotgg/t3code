import {
  ...
  ThreadImportedHistoryClearedPayload as ContractsThreadImportedHistoryClearedPayloadSchema,
...
export const ThreadImportedHistoryClearedPayload =
  ContractsThreadImportedHistoryClearedPayloadSchema;
