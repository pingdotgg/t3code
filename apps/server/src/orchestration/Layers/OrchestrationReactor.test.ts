...
import * as WorktreeTeardownReactor from "../WorktreeTeardownReactor.ts";
  ...
  it("starts every orchestration reactor", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(WorktreeTeardownReactor.WorktreeTeardownReactor, {
            start: () => {
              started.push("worktree-teardown-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
