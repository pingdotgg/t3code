          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                operatorParentThreadId: row.operatorParentThreadId ?? null,
                operatorBatchId: row.operatorBatchId ?? null,
                ...
                usageLimitWait: row.usageLimitWait,
                deletedAt: row.deletedAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        worktreePath: threadRow.value.worktreePath,
        operatorParentThreadId: threadRow.value.operatorParentThreadId ?? null,
        operatorBatchId: threadRow.value.operatorBatchId ?? null,
        ...
        usageLimitWait: threadRow.value.usageLimitWait,
