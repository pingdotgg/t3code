...
/**
 * Delegated sub-agent threads always use the standard service tier. Apply
 * this at the orchestration boundary as well as at spawn time so a client
 * cannot re-enable fast mode on a child thread through metadata or a
