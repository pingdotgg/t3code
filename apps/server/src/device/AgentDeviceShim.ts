...
export const ensureAgentDeviceShim = Effect.fn("AgentDeviceShim.ensure")(function* (input: {
  ...
  // Desktop resolveNodeExecutable returns the Electron binary. Without
  // ELECTRON_RUN_AS_NODE the shim starts a second T3 GUI/backend, which
  // reconciles provider sessions and kills OpenCode/Cursor threads.
