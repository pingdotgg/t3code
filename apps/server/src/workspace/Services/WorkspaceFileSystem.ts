...
export interface WorkspaceFileSystemShape {
   ...
   *
   * Rejects paths that escape the workspace root and reports binary or
   * non-file targets as workspace filesystem errors.
   */
  readonly readFile: (
...
>()("salchi/workspace/Services/WorkspaceFileSystem") {}
