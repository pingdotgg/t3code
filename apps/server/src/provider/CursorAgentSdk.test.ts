  ...
  it.effect("logs agent.close before invoking the Cursor SDK", () =>
    Effect.gen(function* () {
      ...
      const session = yield* runner.open({
        ...
        providerSessionId: "provider-session-cursor-agent-sdk-close-order-test",
      });
  ...
  it.effect("logs agent.close even when the Cursor SDK close fails", () =>
    Effect.gen(function* () {
      ...
      const session = yield* runner.open({
        ...
        providerSessionId: "provider-session-cursor-agent-sdk-close-failure-test",
      });
  ...
  it.effect("surfaces interaction callback failures through run.wait", () =>
    Effect.gen(function* () {
      ...
      const session = yield* runner.open({
        ...
        providerSessionId: "provider-session-cursor-agent-sdk-test",
      });
