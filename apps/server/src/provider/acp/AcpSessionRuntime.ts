...
export interface AcpSessionRuntimeOptions {
  ...
  /**
   * Auth method id sent via `authenticate` after initialize. Omit for agents
   * that rely on their own cached login (e.g. a CLI the user already signed
   * in to) and advertise no method we can name up front.
   */
