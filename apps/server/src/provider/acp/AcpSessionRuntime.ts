...
export interface AcpSessionRuntimeOptions {
  ...
  /**
   * ACP `authenticate` method id. Omitted by agents that gate access through
   * environment credentials and advertise no auth methods (Prime Agent): the
   * runtime then skips `authenticate` instead of sending an unknown method.
   */
