 ...
 */
export const buildCodexBrowserInstructions = (
  availability: boolean | T3CodeToolAvailability,
): string => (normalizeAvailability(availability).browser ? T3_CODE_BROWSER_TOOL_INSTRUCTIONS : "");

const deviceToolInstructions = (availability: boolean | T3CodeToolAvailability): string =>
  normalizeAvailability(availability).device ? T3_CODE_DEVICE_TOOL_INSTRUCTIONS : "";
...
${deviceToolInstructions(browserToolsAvailable)}
</collaboration_mode>`;
