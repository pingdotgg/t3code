...
const unsupportedTextGeneration = (operation: string) =>
  Effect.fail(
    new TextGenerationError({
      operation,
      detail:
        "ChatGPT browser connector does not support background text generation. Select Codex, Claude, Cursor, Grok, or OpenCode for commit messages, PR text, branch names, and titles.",
    }),
  );
