...
export const HermesDriver: ProviderDriver<HermesSettings, HermesDriverEnv> = {
  ...
  create: ({ instanceId, displayName, accentColor, environment, enabled, config }) =>
    Effect.gen(function* () {
      ...
      // Hermes has no out-of-session text-generation API; every op fails
      // uniformly so commit messages / PR titles fall back the same way
      // they would for any provider instance lacking this capability.
