...
for (const { source, instanceId, providerSessionId, model, resumeCursor } of [
  {
    source: "codex" as const,
    instanceId: "codex",
    providerSessionId: "native-codex-thread",
    model: "gpt-5.4",
    resumeCursor: { threadId: "native-codex-thread" },
  },
  {
    source: "muse" as const,
    instanceId: "muse-work",
    providerSessionId: "48af9116-9220-4a13-94f4-d0593510582a",
    model: "muse-spark-1.3-contributor",
    resumeCursor: { sessionId: "48af9116-9220-4a13-94f4-d0593510582a" },
  },
]) {
  ...
  it.effect(
    `${source}: imports messages once and preserves the provider native resume binding`,
    () => {
