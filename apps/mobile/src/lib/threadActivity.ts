...
/**
 * Wraps a build function so it runs at most once — repeated calls (e.g. one
 * work-log row expanded and then copied) replay the cached value instead of
 * re-serializing large tool payloads.
 */
