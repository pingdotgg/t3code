...
/**
 * Claude's brand orange holds in both themes; the others are neutrals and must
 * flip with the theme or their bars vanish against the matching background.
 * Codex, Grok, and OpenCode step down in contrast so stacked bars stay
 * separable.
 */
export function useProviderColors(): Record<UsageProviderKind, string> {
  ...
  return {
    ...
    opencode: scheme === "dark" ? "#71717a" : "#a1a1aa",
  };
}
