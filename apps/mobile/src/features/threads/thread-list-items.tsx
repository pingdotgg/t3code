...
export const ThreadListRow = memo(function ThreadListRow(props: {
  ...
  const materialSelectedForegroundColor = useThemeColor("--color-thread-selected-foreground");
  ...
  const rowContent = (close: () => void) =>
    compact ? (
      <Pressable
        ...
        accessibilityRole="button"
        className={materialYouStyleLayoutActive ? undefined : "bg-screen"}
        onPress={() => {
          close();
        ...
        style={({ pressed }) => ({
          backgroundColor: visuallySelected
            ...
            : pressed
              ...
              : backgroundColor,
          borderRadius: materialYouStyleLayoutActive ? SIDEBAR_ROW_RADIUS : 0,
