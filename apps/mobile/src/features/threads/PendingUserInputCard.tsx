          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text
                ...
                className="font-t3-bold text-xs uppercase tracking-[1px] text-foreground-muted"
              >
                {question.header}
              </Text>
              <Text
                style={proseDirectionStyle(question.question)}
                className="font-sans text-base leading-snug text-foreground"
              >
                {question.question}
              </Text>
                      ...
                      <View className="min-w-0 flex-1 gap-0.5">
                        ...
                        {description ? (
                          <Text
                            ...
                            className="font-sans text-sm leading-5 text-foreground-muted"
                          >
                            {description}
                          </Text>
                        ) : null}
