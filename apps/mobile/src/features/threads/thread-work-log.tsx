...
type WorkContentIcon = "wrench" | AppSymbolName | "browser" | "device" | "t3-code" | "pull-request";
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly summaryToolIcon?: "wrench" | "browser" | "device" | "t3-code" | "pull-request" | "brain";
  readonly themeAppearance: "light" | "dark";
