...
function renderFeedEntry(
  ...
  if (entry.type === "message") {
    ...
    const displayText = isUser ? visibleDesignCommand(message.text) : message.text;
    ...
    const hasWideBlock = hasWideMarkdownBlock(displayText, WIDE_MARKDOWN_BLOCK_OPTIONS);
