 ...
 *
 * Color is reserved for "act now" (approval), "in motion" (working), and
 * "broken" (failed). Ready is the unlabeled resting state.
 */
...
export function resolveThreadListV2Status(
  ...
  // The parent turn can settle while subagents or watch loops run on; the
  // server reports that as backgroundLiveness (same as the web sidebar).
