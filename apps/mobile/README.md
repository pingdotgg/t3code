...
> [!WARNING]
> 2code Mobile is currently in development and is not distributed yet. If you want to try it out, you can build it from source.
...
- `development`: Expo dev client, installable side-by-side as `2code Dev`
- `preview`: persistent internal preview build, installable side-by-side as `2code Preview`
- `production`: store/release build as `2code`
