...
"object" == typeof exports &&
  ...
  (module.exports = hljs); /*! `applescript` grammar compiled for Highlight.js 11.9.0 */
(() => {
  var e = (() => {
    "use strict";
    return (e) => {
      const t = e.regex,
        ...
        n = e.COMMENT(/--/, /$/),
        a = [n, e.COMMENT(/\(\*/, /\*\)/, { contains: ["self", n] }), e.HASH_COMMENT_MODE];
      return {
        name: "AppleScript",
        aliases: ["osascript"],
        keywords: {
  ...
  var e = (() => {
    ...
    return (e) => {
      const n = e.regex,
        ...
        s = "decltype\\(auto\\)",
        a = "[a-zA-Z_]\\w*::",
        r = "(" + s + "|" + n.optional(a) + "[a-zA-Z_]\\w*" + n.optional("<[^<>]+>") + ")",
        i = {
          className: "type",
          variants: [
            { begin: "\\b[a-z\\d_]*_t\\b" },
  ...
  var e = (() => {
    ...
    return (e) => {
      const t = e.regex,
        ...
        r = "[a-zA-Z_]\\w*::",
        i =
          "(?!struct)(" + n + "|" + t.optional(r) + "[a-zA-Z_]\\w*" + t.optional("<[^<>]+>") + ")",
        s = {
          className: "type",
          begin: "\\b[a-z\\d_]*_t\\b",
        },
        ...
        f = {
          ...
          keywords: p,
          contains: m.concat([
            { begin: /\(/, end: /\)/, keywords: p, contains: m.concat(["self"]), relevance: 0 },
          ]),
          relevance: 0,
        },
        g = {
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            contains: [l, c, r, { begin: /\{/, end: /\}/, contains: r.contains }, s],
          },
          { beginKeywords: "default", end: "$", contains: [c, r, s] },
          { beginKeywords: "infix infixl infixr", end: "$", contains: [e.C_NUMBER_MODE, s] },
          {
            begin: "\\bforeign\\b",
            end: "$",
  ...
  var e = (() => {
    ...
    return (e) => {
      const r = "[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*",
        ...
        s = { className: "string", contains: [e.BACKSLASH_ESCAPE, a, i], begin: "`", end: "`" },
  ...
  var e = (() => {
    ...
    return (a) => {
      const l = ((e) => ({
        ...
        p = (e, r, t) => ({ className: e, begin: r, relevance: t }),
        f = { $pattern: /[a-z-]+/, keyword: "and or not only", attribute: r.join(" ") },
        u = { begin: "\\(", end: "\\)", contains: b, keywords: f, relevance: 0 };
      b.push(
        ...
        v = {
          ...
          contains: [
            ...
            l.CSS_VARIABLE,
            {
              ...
              starts: { endsWithParent: !0, illegal: "[<=$]", relevance: 0, contains: b },
            },
          ],
        },
        y = {
          ...
          starts: { end: "[;{}]", keywords: f, returnEnd: !0, contains: b, relevance: 0 },
        },
        w = {
          className: "variable",
          variants: [{ begin: "@" + d + "\\s*:", relevance: 15 }, { begin: "@" + d }],
    ...
    return (e) => {
      ...
      return {
        ...
        contains: [
          ...
          { className: "number", begin: e.C_NUMBER_RE, relevance: 0, starts: s },
...
(() => {
  var e = (() => {
    ...
    return (e) => {
      ...
      return ((s.contains = i), { name: "Nix", aliases: ["nixos"], keywords: n, contains: i });
    };
  })();
  ...
  var e = (() => {
    ...
    return (e) => {
      const n = e.regex,
        ...
        m = (e, s, r) => n.concat(n.concat("(?:", e, ")"), s, /(?:\\.|[^\\\/])*?/, r, t),
        p = [
          c,
          e.HASH_COMMENT_MODE,
          e.COMMENT(/^=\w/, /=cut/, {
      ...
      const n = e.regex,
        ...
        s = {
          ...
          variants: [
            ...
            { className: "string", begin: '[a-z]+"""', end: '"""', contains: [a], relevance: 10 },
          ],
        },
  ...
  var e = (() => {
    ...
    return (e) => {
      const d = { match: /\s+/, relevance: 0 },
        ...
        K = (e = "") => ({ begin: t(e, /"/), end: t(/"/, e), contains: [I(e), P(e)] }),
        j = {
          className: "string",
      ...
      const X = {
        ...
        J = { begin: /</, end: />/, keywords: "repeat each", contains: [...A, H] },
        Q = {
          begin: /\(/,
          end: /\)/,
          keywords: B,
