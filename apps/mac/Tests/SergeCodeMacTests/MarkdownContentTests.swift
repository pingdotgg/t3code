...
struct MarkdownContentTests {
    ...
    func userBubbleRenderingTokens() {
        ...
        #expect(tokens.proseForeground == .primary)
        #expect(tokens.headingForeground == .primary)
        #expect(tokens.listMarkerForeground == .whiteOpacity(0.66))
        #expect(tokens.taskCheckboxForeground == .whiteOpacity(0.66))
        #expect(tokens.inlineCodeBackground == .whiteOpacity(0.10))
        #expect(tokens.quoteBar == .accentOpacity(MarkdownTheme.quoteAccentOpacity))
        #expect(tokens.quoteText == .whiteOpacity(0.78))
        #expect(tokens.quoteFill == .whiteOpacity(0.06))
        #expect(tokens.rule == .whiteOpacity(0.18))
