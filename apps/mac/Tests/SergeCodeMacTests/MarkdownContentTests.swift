...
struct MarkdownContentTests {
    ...
    func userBubbleRenderingTokens() {
        ...
        #expect(tokens.proseForeground == .forest)
        #expect(tokens.headingForeground == .forest)
        #expect(tokens.listMarkerForeground == .forestOpacity(0.72))
        #expect(tokens.taskCheckboxForeground == .forestOpacity(0.72))
        #expect(tokens.inlineCodeBackground == .forestOpacity(0.12))
        #expect(tokens.quoteBar == .forestOpacity(0.55))
        #expect(tokens.quoteText == .forestOpacity(0.82))
        #expect(tokens.quoteFill == .forestOpacity(0.08))
        #expect(tokens.rule == .forestOpacity(0.28))
