...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(configuredBaseDir, () => path.join(homeDirectory, ".forma"));
  ...
  const userDataDirName = isDevelopment ? "forma-dev" : "forma";
  const legacyUserDataDirName = isDevelopment ? "Forma (Dev)" : "Forma (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    linuxDesktopEntryName: isDevelopment ? "forma-dev.desktop" : "forma.desktop",
    linuxWmClass: isDevelopment ? "forma-dev" : "forma",
    userDataDirName,
