...
export const PREVIEW_CONFIGURE_GATEWAY_CHANNEL = "desktop:preview-configure-gateway";
export const PREVIEW_CLEAR_GATEWAY_CHANNEL = "desktop:preview-clear-gateway";
