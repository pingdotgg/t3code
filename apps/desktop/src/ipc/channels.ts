...
export const SCREENSHOT_HOTKEY_CHANNEL = "desktop:screenshot-hotkey";
export const OPEN_SCREEN_RECORDING_SETTINGS_CHANNEL = "desktop:open-screen-recording-settings";
