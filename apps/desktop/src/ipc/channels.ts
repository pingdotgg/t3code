...
export const VOICE_BUD_BIND_RECORDING_CHANNEL = "desktop:voicebud-bind-recording";
export const VOICE_BUD_ACKNOWLEDGE_DELIVERY_CHANNEL = "desktop:voicebud-acknowledge-delivery";
export const VOICE_BUD_RECORDING_STARTED_CHANNEL = "desktop:voicebud-recording-started";
export const VOICE_BUD_TRANSCRIPTION_CHANNEL = "desktop:voicebud-transcription";
