...
export const PREVIEW_GET_TAB_STATE_CHANNEL = "desktop:preview-get-tab-state";
export const PREVIEW_CLOSE_TAB_CHANNEL = "desktop:preview-close-tab";
export const PREVIEW_SET_SURFACE_CHANNEL = "desktop:preview-set-surface";
...
export const PREVIEW_CAPTURE_SURFACE_FRAME_CHANNEL = "desktop:preview-capture-surface-frame";
