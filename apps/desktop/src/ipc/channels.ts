...
export const OPEN_EXTERNAL_GITHUB_ACCOUNT_CHANNEL = "desktop:open-external-github-account";
...
export const PREVIEW_REMOTE_STREAM_START_CHANNEL = "desktop:preview-remote-stream-start";
export const PREVIEW_REMOTE_STREAM_STOP_CHANNEL = "desktop:preview-remote-stream-stop";
export const PREVIEW_REMOTE_INPUT_CHANNEL = "desktop:preview-remote-input";
export const PREVIEW_REMOTE_FRAME_CHANNEL = "desktop:preview-remote-frame";
