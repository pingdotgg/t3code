...
export const PUBLISH_AGENT_ACTIVITY_SNAPSHOT_CHANNEL = "desktop:publish-agent-activity-snapshot";
export const CLEAR_AGENT_ACTIVITY_SNAPSHOT_CHANNEL = "desktop:clear-agent-activity-snapshot";
