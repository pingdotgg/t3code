...
export const REPORT_ACTIVE_THREAD_CHANNEL = "desktop:report-active-thread";
export const CONSUME_NOTIFICATION_TARGET_CHANNEL = "desktop:consume-notification-target";
export const NOTIFICATION_TARGET_AVAILABLE_CHANNEL = "desktop:notification-target-available";
