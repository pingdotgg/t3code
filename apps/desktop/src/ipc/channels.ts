...
export const DESKTOP_APP_CONNECTION_READY_CHANNEL = "desktop:app-connection-ready";
export const DESKTOP_APP_CONNECTION_COMPLETE_CHANNEL = "desktop:app-connection-complete";
export const DESKTOP_APP_CONNECTION_REQUEST_CHANNEL = "desktop:app-connection-request";
export const DESKTOP_APP_CONNECTION_CANCEL_CHANNEL = "desktop:app-connection-cancel";
