...
const DESKTOP_BACKEND_ENV_NAMES = [
  "MORECODE_T3CODE_PORT",
  "MORECODE_T3CODE_MODE",
  "MORECODE_T3CODE_NO_BROWSER",
  "MORECODE_T3CODE_HOST",
  "MORECODE_T3CODE_DESKTOP_WS_URL",
  "MORECODE_T3CODE_DESKTOP_LAN_ACCESS",
  "MORECODE_T3CODE_DESKTOP_LAN_HOST",
  "MORECODE_T3CODE_DESKTOP_HTTPS_ENDPOINTS",
  "MORECODE_T3CODE_TAILSCALE_SERVE",
  "MORECODE_T3CODE_TAILSCALE_SERVE_PORT",
] as const;
