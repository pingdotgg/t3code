...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  retryWslBackend: () => ipcRenderer.invoke(IpcChannels.RETRY_WSL_BACKEND_CHANNEL),
  getWslDiagnosticReport: () => ipcRenderer.invoke(IpcChannels.GET_WSL_DIAGNOSTIC_REPORT_CHANNEL),
