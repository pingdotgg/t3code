// This file mostly exists because we want dev mode to say "Salchi (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Salchi (Dev)" : "Salchi (Alpha)";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "salchi", "salchi-icon-1024.png");
