  ...
  return (
    <ComboboxPrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "dropdown-glass floating-surface-motion relative flex max-h-full min-w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) rounded-lg shadow-[0_16px_40px_-18px_rgb(0_0_0/55%)] dark:shadow-[0_18px_44px_-18px_rgb(0_0_0/80%)]",
            className,
          )}
        >
