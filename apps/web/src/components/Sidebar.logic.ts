...
export function resolveThreadRowClassName(input: {
  ...
  const baseClassName =
    "h-11 md:h-7 w-full translate-x-0 cursor-pointer justify-start px-2.5 md:px-2 text-left select-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ring";
