        ...
        >
          <div className="relative z-10 h-[4.875rem] px-2.5 py-2">
            <div className="flex h-5 min-w-0 items-center gap-1.5">
              ...
              <span className="group/v2-status relative ml-auto flex h-5 min-w-8 shrink-0 items-center justify-end pl-1 text-xs">
                <span
                  className={cn(
                    "tabular-nums text-muted-foreground/65 transition-opacity group-hover/v2-row:opacity-0 group-has-[:focus-visible]/v2-status:opacity-0",
                ...
                {props.settlementSupported || showSnoozeButton ? (
                  <span
                    className={cn(
                      ...
                      "absolute inset-y-0 right-0 flex items-stretch gap-0.5 opacity-0 transition-opacity group-hover/v2-row:opacity-100 has-[:focus-visible]:opacity-100",
