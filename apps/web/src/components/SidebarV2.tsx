...
function SidebarV2SettledLifecycleControls({
  ...
  return (
    <span
      className={cn(
        "pointer-events-none absolute inset-y-0 right-0 -mr-1 inline-flex items-center opacity-0 transition-opacity has-[:focus-visible]:pointer-events-auto has-[:focus-visible]:opacity-100 group-hover/v2-row:pointer-events-auto group-hover/v2-row:opacity-100",
        preserveWokeStatus && "has-[:focus-visible]:static group-hover/v2-row:static",
      )}
    >
      {settlementSupported ? (
        <button
            ...
            >
              <span
                className={cn(
                  ...
                  !isWoke &&
                    "group-has-[:focus-visible]/v2-slim-status-slot:opacity-0 group-hover/v2-row:opacity-0",
                )}
              >
              ...
              {variantAction === "unsnooze" ? (
                ...
                <button
                  ...
                  className={cn(
                    "pointer-events-none absolute inset-y-0 right-0 opacity-0 transition-opacity focus-visible:pointer-events-auto focus-visible:opacity-100 group-hover/v2-row:pointer-events-auto group-hover/v2-row:opacity-100",
                    SIDEBAR_V2_ROW_LIFECYCLE_BUTTON_CLASS_NAME,
                    isWoke && "group-hover/v2-row:static",
                  )}
                >
