    ...
    void (async () => {
      ...
      if (!isAtomCommandInterrupted(result)) {
        ...
        toastManager.add(
          stackedThreadToast({
            type: "error",
            title: t("plan.saveFailed"),
            description: error instanceof Error ? error.message : t("plan.error"),
          }),
        );
      }
    })();
    ...
    >
      ...
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-border/60 px-3">
        <div className="flex items-center gap-2">
          ...
          >
            {label === "Plan" ? t("rightPanel.plan") : label}
          </Badge>
          {activePlan ? (
            ...
            <Menu>
              ...
              <MenuPopup align="end">
                <MenuItem onClick={handleCopyPlan}>
                  {isCopied ? t("plan.copied") : t("plan.copy")}
                </MenuItem>
                <MenuItem onClick={handleDownload}>{t("plan.download")}</MenuItem>
                <MenuItem
        ...
        <div className="p-3 space-y-4">
          ...
          {!activePlan && !planMarkdown ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <p className="text-[13px] text-muted-foreground/40">{t("plan.empty")}</p>
