/**
 * The "Publish repository" flow: pick a provider, name the repository, and
 * create it with a remote wired up.
 *
 * Lives apart from GitActionsControl so both the chat-header split button and
 * the Git panel can open the same dialog.
 */
...
import { useSourceControlPublishRepositoryAction } from "~/state/sourceControlActions";
import {
