  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <AddProviderInstanceDialogContent
        key={open ? "add-provider-open" : "add-provider-closed"}
...
interface AddProviderInstanceDialogContentProps {
  onOpenChange: (open: boolean) => void;
}

function AddProviderInstanceDialogContent({ onOpenChange }: AddProviderInstanceDialogContentProps) {
