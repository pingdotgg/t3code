...
function ImageGenerationProviderSetting() {
  ...
  return (
    <SettingsRow
      ...
      description="Codex is the default. Switch to Grok to use Grok Build. A prompt that explicitly asks for Grok still uses Grok."
      resetAction={
...
function ImageGenerationGrokModelSetting() {
  ...
  return (
    <SettingsRow
      ...
      description="Imagine model Grok Build should prefer when it generates an image."
      resetAction={
