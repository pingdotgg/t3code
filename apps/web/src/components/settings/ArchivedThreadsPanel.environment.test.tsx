...
const archiveState = vi.hoisted(() => ({
  scope: { kind: "all", label: "All", members: [], environmentIds: [] } as ResolvedSettingsScope,
...
vi.mock("./SettingsScopeContext", () => ({
  useSettingsScope: () => ({ scope: archiveState.scope }),
}));
...
describe("ArchivedThreadsPanel environment loading", () => {
  beforeEach(() => {
    hooks.reset();
    archiveState.scope = { kind: "all", label: "All", members: [], environmentIds: [] };
