...
import { scopeThreadRef } from "@workbench/client-runtime";
...
const PROVIDER_SETTINGS: readonly InstallProviderSettings[] = [
  ...
  },
  {
    ...
    serverUrlDescription: "Leave blank to let Workbench spawn the server when needed",
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Workbench looks across the app."
          resetAction={
            theme !== "system" ? (
