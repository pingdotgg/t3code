      ...
      >
        ...
        >
          <SettingsRow
            ...
            description={`Default model for generated text like thread titles and source control content on ${environmentLabel}. Source control settings can override it with a dedicated source control writer model.`}
            resetAction={
