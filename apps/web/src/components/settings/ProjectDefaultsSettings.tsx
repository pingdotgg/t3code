      ...
      {category === "general" ? (
        ...
        <>
          ...
          <SettingsRow
            ...
            description="Let Codex control the environment through Cua Driver. Host permissions are required. Start a new session after enabling. Disabling revokes managed access."
            resetAction={
