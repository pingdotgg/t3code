...
export const PROVIDER_PRESENTATION = {
  ...
  opencode: {
    label: "OpenCode",
    // OpenCode's mark is monochrome like Codex's, so it takes the next step
    // down the same neutral ramp rather than borrowing a hue it does not own.
    color: "color-mix(in oklab, var(--contrast-foreground) 46%, var(--background))",
    mark: OpenCodeIcon,
  },
