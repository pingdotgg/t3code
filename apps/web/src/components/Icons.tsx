...
export const DevinIcon: Icon = ({ className, ...props }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="none"
    className={cn("fill-[#0F0F12] dark:fill-[#F5F5F5]", className)}
  >
    <path d="M5.91 3.76c-0.9 0.52-1.72 1.01-1.8 1.09c-0.15 0.13-0.17 0.37-0.17 2.23c0 1.87 0.02 2.1 0.17 2.23c0.32 0.29 3.45 2.05 3.64 2.05c0.1 0 0.65-0.26 1.2-0.58c1.1-0.65 1.62-0.78 2.25-0.56c0.94 0.31 1.51 1.34 1.27 2.3c-0.21 0.83-1.03 1.45-1.91 1.45c-0.31 0-1.07-0.34-2.06-0.93c-0.42-0.24-0.71-0.37-0.83-0.33c-0.29 0.09-3.57 2.01-3.65 2.13c-0.04 0.07-0.08 1.02-0.08 2.14c0 1.8 0.02 2.05 0.17 2.21c0.22 0.24 3.43 2.09 3.65 2.09c0.17 0 2.93-1.55 3.47-1.93l0.29-0.23l0.04-1.33c0.03-1.22 0.05-1.38 0.25-1.73c0.13-0.23 0.39-0.52 0.6-0.66c0.33-0.23 0.47-0.26 1.05-0.26c0.65 0 0.69 0.02 1.69 0.58c0.55 0.33 1.1 0.59 1.2 0.59c0.25 0 3.61-1.95 3.72-2.16c0.06-0.1 0.09-1.06 0.09-2.18c0-1.96 0-2.01-0.21-2.19c-0.2-0.17-2.59-1.57-3.34-1.94l-0.31-0.16l-1.08 0.62c-1.51 0.87-2.2 0.91-3.01 0.21c-0.56-0.5-0.68-0.87-0.68-2.27c0-0.68-0.04-1.27-0.08-1.33c-0.12-0.2-3.48-2.09-3.69-2.09c-0.12 0-0.96 0.43-1.86 0.95Z" />
  </svg>
);
