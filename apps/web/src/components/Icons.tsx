...
export const GrokIcon: Icon = ({ className, ...props }) => (
  ...
  >
    ...
    <path d="M7.62249 16.7237C4.83113 14.0422 5.3124 9.89222 7.69417 7.49905C9.45541 5.72786 12.341 5.00497 14.86 6.06768L17.5653 4.81138C17.0779 4.45714 16.4553 4.07613 15.7365 3.80839C12.4966 2.46764 8.6178 3.13492 5.98413 5.78141C3.45081 8.32904 2.65415 12.2463 4.02219 15.5889C5.04412 18.0871 3.36889 19.8541 1.68137 21.6377C1.08337 22.2699 0.483318 22.9022 0 23.5716L7.62045 16.7257" />
  </svg>
);
...
export const ZaiIcon: Icon = ({ className, ...props }) => (
  ...
  >
    <path d="M15.47 7.1l-1.3 1.85c-.2.29-.54.47-.9.47h-7.1V7.09C6.16 7.1 15.47 7.1 15.47 7.1z" />
    <path d="M24.3 7.1 13.14 22.91H5.7L16.86 7.1z" />
    <path d="M14.53 22.91l1.31-1.86c.2-.29.54-.47.9-.47h7.09v2.33z" />
  </svg>
);
