...
export type ProviderIconVariant = "brand" | "monochrome";
export type ProviderIcon = React.FC<SVGProps<SVGSVGElement> & { variant?: ProviderIconVariant }>;
...
export const CursorIcon: ProviderIcon = ({ variant = "brand", className, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 466.73 532.09"
    className={cn(
      variant === "brand" && "fill-[#26251E] dark:fill-[#EDECEC]",
      variant === "monochrome" && "fill-current text-current",
      className,
    )}
  >
...
export const GrokIcon: ProviderIcon = ({ variant = "brand", className, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
    className={cn(
      variant === "brand" && "fill-[#0F0F0F] dark:fill-[#F5F5F5]",
      variant === "monochrome" && "fill-current text-current",
      className,
    )}
  >
...
export const OpenAI: ProviderIcon = ({ variant = "brand", className, ...props }) => (
  <svg
    {...props}
    preserveAspectRatio="xMidYMid"
    viewBox="0 0 256 260"
    className={cn(
      variant === "brand" && "fill-black dark:fill-white",
      variant === "monochrome" && "fill-current text-current",
      className,
    )}
  >
...
export const ClaudeAI: ProviderIcon = ({ variant = "brand", className, ...props }) => (
  <svg
    {...props}
    preserveAspectRatio="xMidYMid"
    viewBox="0 0 256 257"
    className={cn(
      variant === "brand" && "fill-[#d97757]",
      variant === "monochrome" && "fill-current text-current",
      className,
    )}
  >
...
export const OpenCodeIcon: ProviderIcon = ({ variant = "brand", className, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 32 40"
    fill="none"
    className={cn(variant === "monochrome" && "text-current", className)}
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#opencode__clip0_1311_94969)">
      {variant === "monochrome" ? (
        <>
          <path d="M24 32H8V16H24V32Z" fill="currentColor" fillOpacity="0.25" />
