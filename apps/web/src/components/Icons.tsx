...
export const OllamaIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="currentColor">
    <path d="M7.5 4a2.5 2.5 0 0 0-2.5 2.5v5.1A4.9 4.9 0 0 0 2 16a5 5 0 0 0 10 0 4.9 4.9 0 0 0-3-4.4V6.5A1.5 1.5 0 0 0 7.5 5h-1A1.5 1.5 0 0 0 5 6.5v4.7a5 5 0 1 1 9.8 1.3h1.7A6.7 6.7 0 0 0 17 10V6.5A2.5 2.5 0 0 0 14.5 4h-7Z" />
    <circle cx="8.5" cy="16" r="1.1" />
    <circle cx="16.2" cy="16" r="1.1" />
    <path d="M12.35 19.6c.8 0 1.56-.32 2.12-.88l.03-.03-.71-.71-.02.02a2 2 0 0 1-2.84 0l-.02-.02-.71.71.03.03c.56.56 1.32.88 2.12.88Z" />
  </svg>
);
