...
export const OllamaIcon: Icon = ({ className, ...props }) => (
  <svg
    ...
    className={cn("fill-black dark:fill-white", className)}
  >
    <path d="M12 2C9.79 2 8 3.79 8 6c0 .35.05.69.13 1.02C5.54 8.2 4 10.38 4 13c0 1.96.98 3.69 2.46 4.74C6.17 18.5 5 19.5 5 21h2c0-1.5 1-2 2.5-2.5.5.3 1.04.5 1.5.7V22h2v-2.8c.46-.2 1-.4 1.5-.7C16 19 17 19.5 17 21h2c0-1.5-1.17-2.5-1.46-3.26C19.02 16.69 20 14.96 20 13c0-2.62-1.54-4.8-4.13-5.98C15.95 6.69 16 6.35 16 6c0-2.21-1.79-4-4-4zm-1.5 4c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5S10.5 6.83 10.5 6zM9 12c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm6 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1z" />
  </svg>
);
