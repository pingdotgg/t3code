...
export const GitLabIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" className={cn("fill-[#FC6D26]", props.className)}>
...
export const JiraIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" className={cn("fill-[#0052CC]", props.className)}>
