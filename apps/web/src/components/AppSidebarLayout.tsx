...
// Settings swaps the thread sidebar out of the tree. Keep its lightweight
// projections subscribed so returning never briefly renders empty project or
// thread lists while the environment snapshot reconnects.
