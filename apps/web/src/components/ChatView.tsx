...
function ChatViewContent(props: ChatViewProps) {
  ...
  const canMaximizeRightPanel = !isGridPane && workspacePanelOpen && !shouldUseRightPanelSheet;
  const rightPanelMaximized =
    canMaximizeRightPanel && maximizedRightPanelThreadKey === routeThreadKey;
  const inlineRightPanelOwnsTitleBar = workspacePanelOpen && !shouldUseRightPanelSheet;
  ...
  const panelLayoutControls = (
    <div
      className={cn(
        ...
        workspacePanelOpen && !shouldUseRightPanelSheet
  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      {isGridPane && ownsGlobalInteraction && rightPanelPortalTarget
        ...
        : null}
      {!isGridPane && workspacePanelOpen && !shouldUseRightPanelSheet ? panelLayoutControls : null}
      <div
        className={cn(
