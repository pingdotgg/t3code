      ...
      <PopoverTrigger
        render={
          <Button
            ...
            className={cn(
              "min-w-0 justify-start overflow-hidden whitespace-nowrap rounded-[999px] px-2 text-muted-foreground/70 before:rounded-[inherit] hover:text-foreground/80 [&_svg]:mx-0",
