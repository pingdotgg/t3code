...
describe("deriveTurnActivityTrace", () => {
  it("surfaces normally hidden provider lifecycle events and the latest assistant feedback", () => {
  ...
  it("reports no feedback when a request has started but no matching event arrived", () => {
    expect(
      deriveTurnActivityTrace({
        activeTurnId: null,
        activeTurnStartedAt: "2026-01-01T00:00:10Z",
