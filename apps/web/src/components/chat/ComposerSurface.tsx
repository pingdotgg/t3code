  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:absolute before:inset-0 before:-z-1 before:rounded-b-[16px] before:border before:border-(--chat-composer-outline) before:mask-[linear-gradient(to_bottom,transparent_0_calc(1rem-1px),black_calc(1rem-1px))] before:shadow-[0_12px_28px_-18px_rgb(0_0_0/40%)]",
