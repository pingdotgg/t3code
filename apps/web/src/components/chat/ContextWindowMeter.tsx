    ...
    <Popover>
      ...
      <PopoverPopup tooltipStyle side="top" align="end" className="w-64 max-w-none p-0">
        <div className="flex flex-col gap-2 p-3">
          ...
          {showTotalProcessed || usage.compactsAutomatically ? (
            <div className="mt-2 text-pretty text-[11px] text-muted-foreground/70">
              {showTotalProcessed
                ? `You have used ${formatContextWindowTokens(totalProcessedTokens)} tokens.`
                : null}
              {showTotalProcessed && usage.compactsAutomatically ? " " : null}
