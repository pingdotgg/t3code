...
export class PreviewAutomationVisibilityTimeoutError extends Schema.TaggedError<PreviewAutomationVisibilityTimeoutError>()(
...
export class PreviewAutomationBackgroundPresentationTimeoutError extends Schema.TaggedError<PreviewAutomationBackgroundPresentationTimeoutError>()(
...
export class PreviewAutomationHostDeadlineExceededError extends Schema.TaggedError<PreviewAutomationHostDeadlineExceededError>()(
