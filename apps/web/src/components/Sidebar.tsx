        ...
        >
          <div className="relative z-10 h-[4.875rem] px-[var(--sidebar-row-content-inset)] py-[var(--sidebar-content-inset)]">
            ...
            <div className="mt-0.5 flex min-w-0 items-center gap-1.5 text-secondary-label text-xs">
              {/* Keep the generated subtitle visible without letting transient
                  plan progress displace the thread's stable row metadata. */}
...
export default function Sidebar() {
  ...
  const visibleSettledThreads = useMemo(() => {
    ...
    return visible;
  }, [highlightedThreadKey, settledThreads, settledVisibleCount]);
  ...
  }, [highlightedThreadKey, settledShelfExpanded, visibleSettledThreads]);
