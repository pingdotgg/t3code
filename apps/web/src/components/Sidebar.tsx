...
export default function Sidebar() {
  ...
  const showSidebarStartupState = !threadsHydrated;
    ...
    <>
      ...
      <SidebarContent className="gap-0">
        ...
        <SidebarGroup className="px-2 py-2">
          ...
          {showSidebarStartupState ? (
            <div className="px-2 pt-3">
              <div
                aria-busy="true"
                aria-live="polite"
                className="flex min-h-28 flex-col items-center justify-center rounded-2xl border border-dashed border-border/70 bg-muted/20 px-4 py-5 text-center"
              >
                <Spinner className="size-4 text-muted-foreground/75" />
                <p className="mt-3 text-xs font-medium text-foreground/85">
                  Loading projects and threads
                </p>
                <p className="mt-1 max-w-52 text-[11px] leading-relaxed text-muted-foreground/70">
