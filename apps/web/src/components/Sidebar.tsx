...
export default function Sidebar() {
  ...
  const { archiveThread, deleteThread, confirmAndDeleteThread } =
    useThreadActions();
    ...
    <>
      ...
      <SidebarContent className="gap-0">
        ...
        <SidebarGroup className="px-2 py-2">
          <div className="mb-1 flex items-center justify-between pl-2 pr-2.5">
                              ...
                              <TooltipTrigger
                                render={
                                  <SidebarMenuAction
                                    ...
                                    showOnHover
                                    className="top-1 right-2.5 size-5 rounded-md p-0 text-muted-foreground/70 hover:bg-secondary hover:text-foreground"
                                    onClick={(event) => {
                                      event.preventDefault();
                                      event.stopPropagation();
                                      ...
                                      <div className="ml-auto flex shrink-0 items-center gap-1.5">
                                        ...
                                        <div className="flex min-w-12 justify-end">
                                          {confirmingArchiveThreadId ===
                                            thread.id && !isThreadRunning ? (
                                            <button
                                              type="button"
                                              data-thread-selection-safe
                                              aria-label={`Confirm archive ${thread.title}`}
                                              className="absolute top-1/2 right-1 inline-flex h-5 cursor-pointer -translate-y-1/2 items-center rounded-md bg-destructive/10 px-2.5 text-xs font-medium text-destructive-foreground transition-colors hover:bg-destructive/14 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-destructive/40"
                                              onPointerDown={(event) => {
                                                event.stopPropagation();
                                              }}
                                              onClick={(event) => {
                                            ...
                                            appSettings.confirmThreadArchive ? (
                                              <button
                                                ...
                                                className="absolute top-1/2 right-1 inline-flex size-7 cursor-pointer -translate-y-1/2 items-center justify-center text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring"
                                                onPointerDown={(event) => {
                                                  event.stopPropagation();
                                                }}
                                                onClick={(event) => {
                                            ...
                                            <span
                                              className={`${
                                                isHighlighted
                                                  ? "text-[10px] text-foreground/72 dark:text-foreground/82"
