...
/**
 * The PostHog palette the app wears with no theme installed, captured from the
 * app's stock tokens (index.css) so a draft seeded from the default look paints
 * the pixels the user is already seeing. Alpha-bearing tokens are flattened
 * over their real backdrops (canvas, or the sidebar for its rows) because theme
 * colors are stored as opaque OKLCH tokens.
 */
const POSTHOG_LIGHT_THEME_COLORS: ThemeColors = {
  canvas: "#eeefe9",
  chrome: "#eeefe9",
  toolbar: "#eeefe9",
  toolbarForeground: "#151515",
  toolbarBorder: "#d9d9d3",
  toolbarControl: "#f7f7f4",
  toolbarControlForeground: "#151515",
  toolbarControlHover: "#dfe0d8",
  surface: "#f7f7f4",
  surfaceRaised: "#f0f1eb",
  surfaceOverlay: "#f7f7f4",
  text: "#151515",
  textMuted: "#63635b",
  border: "#d9d9d3",
  input: "#c2c2ba",
  ...
  muted: "#e5e6df",
  mutedForeground: "#63635b",
  placeholder: "#63635b",
  secondaryLabel: "#63635b",
  iconMuted: "#63635b",
  error: "#ff474d",
  errorForeground: "#c0161c",
  errorSurface: "#f0ded9",
  warning: "#ffa81c",
  warningForeground: "#8a5200",
  warningSurface: "#f0e6d0",
  update: "#ff5c1c",
  updateForeground: "#ff4800",
  updateSurface: "#f0ddd0",
  accentSurface: "#dfe0d8",
  accentSurfaceForeground: "#151515",
  messageSurface: "#dfe0d8",
  messageForeground: "#151515",
  messageAction: "#ff5c1c",
  messageActionForeground: "#151515",
  messageActionHover: "#fd6b30",
  codeBackground: "#f6f6f3",
  codeForeground: "#151515",
  sidebar: "#e5e6df",
  sidebarForeground: "#151515",
  sidebarMutedForeground: "#63635b",
  sidebarControlSurface: "#dfe0d8",
  sidebarRowHover: "#f1f1ec",
  sidebarRowActive: "#f7f7f4",
  sidebarRowSelected: "#f7f7f4",
  sidebarBorder: "#d9d9d3",
  terminalBackground: "#eeefe9",
  terminalForeground: "#151515",
  terminalCursor: "#ff4800",
  terminalSelection: "#f2cfbc",
  terminalScrollbar: "#d9d9d3",
  terminalScrollbarHover: "#c2c2ba",
};

const POSTHOG_DARK_THEME_COLORS: ThemeColors = {
  canvas: "#1d1f27",
  chrome: "#1d1f27",
  toolbar: "#1d1f27",
  toolbarForeground: "#eeefe9",
  toolbarBorder: "#3a3d48",
  toolbarControl: "#2c2e39",
  toolbarControlForeground: "#eeefe9",
  toolbarControlHover: "#343643",
  surface: "#262832",
  surfaceRaised: "#262832",
  surfaceOverlay: "#2c2e39",
  text: "#eeefe9",
  textMuted: "#9ea0a8",
  border: "#3a3d48",
  input: "#4a4d59",
  ...
  accentForeground: "#151515",
  secondary: "#262832",
  secondaryForeground: "#eeefe9",
  muted: "#262832",
  mutedForeground: "#9ea0a8",
  placeholder: "#9ea0a8",
  secondaryLabel: "#9ea0a8",
  iconMuted: "#9ea0a8",
  error: "#ff474d",
  errorForeground: "#ff9498",
  errorSurface: "#46262e",
  warning: "#ffa81c",
  warningForeground: "#ffc45e",
  warningSurface: "#463725",
  update: "#ff5c1c",
  updateForeground: "#ff8b57",
  updateSurface: "#462a25",
  accentSurface: "#343643",
  accentSurfaceForeground: "#eeefe9",
  messageSurface: "#343643",
  messageForeground: "#eeefe9",
  messageAction: "#ff5c1c",
  messageActionForeground: "#151515",
  messageActionHover: "#e8561d",
  codeBackground: "#252731",
  codeForeground: "#eeefe9",
  sidebar: "#22242d",
  sidebarForeground: "#eeefe9",
  sidebarMutedForeground: "#9ea0a8",
  sidebarControlSurface: "#343643",
  sidebarRowHover: "#2c2e39",
  sidebarRowActive: "#343643",
  sidebarRowSelected: "#343643",
  sidebarBorder: "#3a3d48",
  terminalBackground: "#1d1f27",
  terminalForeground: "#eeefe9",
  terminalCursor: "#ff8b57",
  terminalSelection: "#5c3024",
  terminalScrollbar: "#3a3d48",
  terminalScrollbarHover: "#4a4d59",
};

/**
 * The standard PostHog look as a theme palette, for seeding a new theme when
...
export function getStandardThemeColors(appearance: ThemeAppearance): ThemeColors {
  if (appearance === "dark") {
    return (standardDarkThemeColors ??= decodeThemeColors(POSTHOG_DARK_THEME_COLORS));
  }
  return (standardLightThemeColors ??= decodeThemeColors(POSTHOG_LIGHT_THEME_COLORS));
}
...
/**
 * The status colors the app shows without a theme, read from its own tokens
 * (PostHog coral and yellow). Generated palettes fall back to these instead of
 * the flagship theme's, so an imported or created theme never inherits a brand
 * tint on destructive buttons and warnings.
 */
