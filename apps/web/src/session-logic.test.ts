...
describe("deriveWorkLogEntries", () => {
  ...
  it("derives bounded subagent details and collapses lifecycle updates by tool call id", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        id: "subagent-update",
        createdAt: "2026-02-23T00:00:01.000Z",
      ...
      makeActivity({
        ...
        payload: {
          ...
          data: {
            ...
            rawOutput: {
              content: "Alpha found the relevant flow.",
            },
          },
        },
      }),
  ...
  it("keeps failed subagent terminal state when stale running updates arrive later", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        id: "subagent-failed",
        createdAt: "2026-02-23T00:00:01.000Z",
