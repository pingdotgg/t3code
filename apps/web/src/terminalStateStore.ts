...
import { parseScopedThreadKey, scopedThreadKey } from "@forma/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@forma/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "forma:terminal-state:v1";
