...
import { parseScopedThreadKey, scopedThreadKey } from "@harness/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@harness/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "harness:terminal-state:v1";
