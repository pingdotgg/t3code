...
export interface PersistentThreadTerminalDrawerProps {
  ...
  threadId: ThreadId;
  active: boolean;
  /** SDK activity may pause while the thread-owned collapse presentation remains mounted. */
...
export const PersistentThreadTerminalDrawer = memo(function PersistentThreadTerminalDrawer({
  ...
  const visible = active && terminalUiState.terminalOpen && presentationVisible;
...
export interface PersistentThreadTerminalPanelProps {
  visible: boolean;
