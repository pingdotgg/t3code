...
/**
 * Scopes the sidebar thread list to the given project keys; an empty list means all projects.
 *
 * @example setSidebarProjectScopeKeys(state, ["github.com/pingdotgg/t3code"]);
 */
