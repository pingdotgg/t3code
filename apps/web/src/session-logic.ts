...
import {
  derivePendingUserInputs as deriveSharedPendingUserInputs,
  type PendingUserInputPrompt as PendingUserInput,
} from "@t3tools/shared/pendingUserInput";
...
export function derivePendingUserInputs(
  ...
  return deriveSharedPendingUserInputs(activities);
}
