...
import { OpenCode2AutoEnableNotification } from "../components/OpenCode2AutoEnableNotification";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <OpenCode2AutoEnableNotification /> : null}
