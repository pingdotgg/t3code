...
import { AutomaticServerUpdateCoordinator } from "../components/AutomaticServerUpdateCoordinator";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <AutomaticServerUpdateCoordinator /> : null}
