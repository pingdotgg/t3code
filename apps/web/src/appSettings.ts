...
export const CHAT_THREAD_FONT_SIZE_OPTIONS = [
  {
    value: "small",
    label: "Small",
    description: "Display more content per screen with compact text.",
  },
  {
    value: "medium",
    label: "Medium",
  ...
  },
  {
    value: "large",
    label: "Large",
    description: "Increase chat text size for better readability.",
  },
] as const;
export type ChatThreadFontSize = (typeof CHAT_THREAD_FONT_SIZE_OPTIONS)[number]["value"];
const ChatThreadFontSizeSchema = Schema.Literals(["small", "medium", "large"]);
...
const AppSettingsSchema = Schema.Struct({
  ...
  chatThreadFontSize: ChatThreadFontSizeSchema.pipe(
