...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    scrollbarThumb.className =
      "absolute inset-x-px top-0 rounded-[var(--app-scrollbar-thumb-radius)] bg-[var(--app-scrollbar-thumb)] transition-[background-color] duration-[120ms] ease-[ease-out] group-hover:bg-[var(--app-scrollbar-thumb-hover)] group-focus-visible:bg-[var(--app-scrollbar-thumb-hover)]";
