...
import { cssFontFamilies } from "@t3tools/ghostty-terminal/monospaceFonts";

// The terminal's cell grid owns the monospace probe; Settings reuses it.
export {
  areFontAdvancesMonospace,
  cssFontFamilies,
  isMonospaceFamily,
} from "@t3tools/ghostty-terminal/monospaceFonts";
