export const BRAND_ASSET_PATHS = {
  productionMacIconPng: "assets/prod/workbench-macos-1024.png",
  productionLinuxIconPng: "assets/prod/workbench-universal-1024.png",
  productionWindowsIconIco: "assets/prod/workbench-windows.ico",
  productionWebFaviconIco: "assets/prod/workbench-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/workbench-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/workbench-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/workbench-web-apple-touch-180.png",
