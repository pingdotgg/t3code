  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new 2code prerelease is available for nightly testers."
          : "A new 2code latest release is available.",
...
).pipe(Command.withDescription("Post a 2code release announcement to Discord."));
