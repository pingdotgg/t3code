  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new more Code prerelease is available for nightly testers."
          : "A new more Code latest release is available.",
...
).pipe(Command.withDescription("Post a more Code release announcement to Discord."));
