...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    assert.equal(resolveDesktopProductName("0.0.17"), "more Code (Alpha)");
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "more Code (Nightly)");
  });
        ...
        Effect.provide(
          ConfigProvider.layer(
            ConfigProvider.fromEnv({
              env: {
                MORECODE_T3CODE_DESKTOP_SKIP_BUILD: "true",
                MORECODE_T3CODE_DESKTOP_KEEP_STAGE: "true",
                MORECODE_T3CODE_DESKTOP_SIGNED: "true",
                MORECODE_T3CODE_DESKTOP_VERBOSE: "true",
                MORECODE_T3CODE_DESKTOP_MOCK_UPDATES: "true",
              },
            }),
          ),
        ),
