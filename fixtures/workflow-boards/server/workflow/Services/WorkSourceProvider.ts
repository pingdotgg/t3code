...
>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkSourceProvider/WorkSourceProviderRegistry",
) {}

// Placeholder Context.Service tags for the concrete providers.
// C2 provides Layer implementations for these exact tags.
export class GithubIssuesProvider extends Context.Service<
  GithubIssuesProvider,
  WorkSourceProvider
>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkSourceProvider/GithubIssuesProvider",
) {}

export class AsanaProvider extends Context.Service<AsanaProvider, WorkSourceProvider>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkSourceProvider/AsanaProvider",
) {}

export class JiraProvider extends Context.Service<JiraProvider, WorkSourceProvider>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkSourceProvider/JiraProvider",
) {}
