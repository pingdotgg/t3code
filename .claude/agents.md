...
Fork-specific features so far: Codex/ChatGPT account support, system prompt injection, agents/workflows visibility UI, the reworked git panel. Port planning docs live in `.plans/2code-port/` (gitignored).
