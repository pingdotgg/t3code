...
- The runtime-id presentation subset (`previewAutomationPresentation`, `previewAutomationOpenReadiness`, and `previewAutomationRequestConsumer`) passed all 37 tests with explicit runtime guest identity.
