...
- Web row and project actions share collision-safe per-thread in-flight locks, disable overlapping controls, and refresh archived snapshots once after bulk attempts instead of between concurrent mutations.
