...
- `apps/server/src/preview/PortScanner.test.ts` covers snapshot replay without rescanning, ordered replay during concurrent broadcasts, failed-replay listener cleanup, serialized concurrent scans, and unchanged terminal registrations avoiding redundant probes.
