...
Upstream commit `f4c394323` (`Add background preview capture and picture-in-picture support`) supersedes the earlier assumption that this branch owns generic background preview capture. Upstream now owns:
