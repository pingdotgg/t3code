...
Focused regression coverage lives in `apps/server/src/preview/PortScanner.test.ts`. Keep coverage for snapshot replay without rescanning and for unchanged terminal registrations avoiding redundant probes.
