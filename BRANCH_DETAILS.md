...
- The focused command above passed all 218 tests.
- The runtime-id presentation subset (`previewAutomationPresentation`, `previewAutomationOpenReadiness`, `previewAutomationRequestConsumer`, and `previewNavigationReadiness`) passed all 40 tests with explicit runtime guest identity, including immediate open and snapshot rejection after a server-epoch replacement.
