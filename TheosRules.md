...
Prefer changes that leave most users' experience untouched. When something has to come back out, revert it promptly — users should see "nothing changed," not two competing designs in a row.
