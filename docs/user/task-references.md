...
the task chip in a sent message opens the original task.

Task search matches titles, branches, and task IDs. It supports partial and fuzzy queries, with the
most recently active tasks shown when the query is empty.
