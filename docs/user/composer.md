...
Remaining messages wait for subsequent turns. Use the arrow under the bubble to
send it right away, or the X to move it back into the composer. Stop returns
