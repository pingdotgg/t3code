...
Hover over or focus it to reveal **Stash this**. After saving, the count in the
**Stash** tab updates with a brief acknowledgement. Reduced motion skips the
count animation. Open the tab to restore a saved draft.
