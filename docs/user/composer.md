...
until the next limit, or let it disappear on its own once the reset time passes. The same option
also appears first in the thread's snooze menu while the limit is in force.
