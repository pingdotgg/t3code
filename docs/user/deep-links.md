...
Both ids are UUIDs. A link that does not match the format exactly does not navigate. The operating system may still launch the desktop app before the link is checked.
