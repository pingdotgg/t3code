...
settled threads, and you can continue them in T3 Code while the agent still has
that session on disk.
...
assistant messages. It omits tool activity, reasoning, and attachments. For Codex, it omits generated setup
