...
| Antigravity | [Antigravity](https://antigravity.google/docs/ide/extensions) | `agy_acp_server` | Google account (via the binary's own login) |
| OpenCode    | [OpenCode](https://opencode.ai)                               | `opencode`       | `opencode auth login`                       |

Codex and Claude are on by default. Cursor, Grok Build, Antigravity, and OpenCode are off by
...
**Binary path** on the Antigravity card in Settings. Sign in to Antigravity with your Google
account once — T3 Code reuses that cached login and never handles your credentials.
