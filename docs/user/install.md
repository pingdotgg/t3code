...
| Devin      | [Devin CLI](https://devin.ai)                         | `devin`        | see Devin CLI documentation |
...
For multi-account setups, see [Codex](./providers-codex.md), [Claude](./providers-claude.md), and [Devin](./providers-devin.md).
