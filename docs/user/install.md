...
| OMP        | [Oh My Pi](https://github.com/can1357/oh-my-pi)       | `omp`          | `omp setup`           |

Codex and Claude are on by default. Cursor, Grok Build, OpenCode, and OMP are off by default; turn
