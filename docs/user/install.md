...
| Antigravity | [Antigravity CLI](https://antigravity.google/docs/cli/install/) | `agy`          | `agy`                 |

Codex, Claude, Cursor, and Antigravity are on by default. Grok Build and OpenCode are off by default; turn
...
For Antigravity setup and behavior, see [Antigravity](./providers-antigravity.md).
