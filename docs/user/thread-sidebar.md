...
If the project has a teardown script, settling a thread runs it in the thread's worktree, and
un-settling runs the setup script again. See [Project actions](project-scripts.md).
