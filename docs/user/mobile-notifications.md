...
For providers that support goals, alerts report goal completion, blockers, and token or usage limits. Intermediate goal rounds, pause, and clear stay silent.
