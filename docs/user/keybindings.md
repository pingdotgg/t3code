...
The command palette searches active thread titles, generated subtitles, projects, branches, user
messages, and final agent responses across connected environments. Message matches show one labeled excerpt while
