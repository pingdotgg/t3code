...
If an environment is still connecting or reconnecting, **Update** and **Retry** stay disabled and
become available automatically once its status reaches **Connected**.
