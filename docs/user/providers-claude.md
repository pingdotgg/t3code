...
On mobile, an existing thread's saved model can still appear as unavailable.
Choose another model before sending; queued messages using an unavailable model
return to the composer. New tasks skip unavailable saved defaults.
