...
T3CODE_PORT=13773 \
  "/Applications/SergeCode (Alpha).app/Contents/MacOS/SergeCode (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/SergeCode (Alpha).app"
codesign -d --entitlements :- "/Applications/SergeCode (Alpha).app"
```
