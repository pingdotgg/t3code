...
| Pairing window  | The interval during which a server's Tailcat listener accepts any node key: exactly while an unconsumed, unexpired connection code exists.                                                                                       |
