...
The preload bridge exposes a synchronous current snapshot for flash-free boot and an optional change subscription for the running renderer. The web theme library shows **System Theme** only while that snapshot is available.
