...
export const NesRejectReason = Schema.Union(
  ...
  { mode: "oneOf" },
).annotate({ description: "The reason a suggestion was rejected.", identifier: "NesRejectReason" });
...
export const NesTriggerKind = Schema.Union(
  ...
  { mode: "oneOf" },
).annotate({ description: "What triggered the suggestion request.", identifier: "NesTriggerKind" });
