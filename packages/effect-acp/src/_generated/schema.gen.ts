...
export const TextDocumentSyncKind = Schema.Union(
  [
    ...
    Schema.Literal("incremental").annotate({
...
export const TitledMultiSelectItems = Schema.Struct({
  anyOf: Schema.Array(EnumOption)
    .annotate({ description: "Titled enum options. Must contain at least one option." })
...
export type CreateElicitationResponse =
  ...
  | { readonly action: "decline"; readonly _meta?: { readonly [x: string]: Schema.Json } | null }
  | { readonly action: "cancel"; readonly _meta?: { readonly [x: string]: Schema.Json } | null }
  | { readonly action: string; readonly _meta?: { readonly [x: string]: Schema.Json } | null };
export const CreateElicitationResponse = Schema.Union([
  ...
  }).annotate({ description: "Response from the client to an elicitation request." }),
  Schema.Struct({
...
export type SessionUpdate =
  ...
  | { readonly state: string; readonly sessionUpdate: "state_update" }
  | {
...
export const SessionUpdate = Schema.Union([
  ...
  Schema.Union([
    ...
    }).annotate({ description: "The state of the agent's foreground work has changed." }),
    Schema.Struct({
...
export type ElicitationFormMode =
  ...
  | { readonly requestId: RequestId; readonly requestedSchema: ElicitationSchema };
...
export type ElicitationUrlMode =
  ...
  | { readonly requestId: RequestId; readonly elicitationId: ElicitationId; readonly url: string };
