...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+shift+v", command: "preview.toggle" },
  ...
  { key: "mod+shift+h", command: "pane.splitLeft", when: "!terminalFocus" },
  { key: "mod+shift+j", command: "pane.splitDown", when: "!terminalFocus" },
  { key: "mod+shift+k", command: "pane.splitUp", when: "!terminalFocus" },
  { key: "mod+shift+l", command: "pane.splitRight", when: "!terminalFocus" },
  { key: "mod+alt+h", command: "pane.focusLeft", when: "!terminalFocus" },
  { key: "mod+alt+j", command: "pane.focusDown", when: "!terminalFocus" },
  { key: "mod+alt+k", command: "pane.focusUp", when: "!terminalFocus" },
  { key: "mod+alt+l", command: "pane.focusRight", when: "!terminalFocus" },
