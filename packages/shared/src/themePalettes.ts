...
/**
 * Vercel's dark palette, mapped directly from the equivalent OpenCode roles.
 * Every value is one of the source palette's fixed colors so the theme does
 * not drift through generated tints or opacity blends.
 */
const VERCEL_DARK_COLORS: ThemeColors = {
  canvas: "oklch(0 0 0)",
  chrome: "oklch(0 0 0)",
  toolbar: "oklch(0 0 0)",
  toolbarForeground: "oklch(0.946105 0 0)",
  toolbarBorder: "oklch(0.239292 0 0)",
  toolbarControl: "oklch(0.173042 0 0)",
  toolbarControlForeground: "oklch(0.946105 0 0)",
  toolbarControlHover: "oklch(0.239292 0 0)",
  surface: "oklch(0.173042 0 0)",
  surfaceRaised: "oklch(0.239292 0 0)",
  surfaceOverlay: "oklch(0.239292 0 0)",
  text: "oklch(0.946105 0 0)",
  textMuted: "oklch(0.709 0 0)",
  border: "oklch(0.239292 0 0)",
  input: "oklch(0.239292 0 0)",
  focus: "oklch(0.513794 0 0)",
  accent: "oklch(0.730784 0.142312 147.99)",
  accentForeground: "oklch(0 0 0)",
  secondary: "oklch(0.239292 0 0)",
  secondaryForeground: "oklch(0.698358 0.204316 309.75)",
  muted: "oklch(0.239292 0 0)",
  mutedForeground: "oklch(0.709 0 0)",
  placeholder: "oklch(0.709 0 0)",
  secondaryLabel: "oklch(0.709 0 0)",
  iconMuted: "oklch(0.709 0 0)",
  error: "oklch(0.693555 0.18966 3.907)",
  errorForeground: "oklch(0.693555 0.18966 3.907)",
  errorSurface: "oklch(0.181544 0.03411 0.904)",
  warning: "oklch(0.772063 0.173063 64.282)",
  warningForeground: "oklch(0.772063 0.173063 64.282)",
  warningSurface: "oklch(0.173042 0 0)",
  update: "oklch(0.717327 0.152224 251.001)",
  updateForeground: "oklch(0.717327 0.152224 251.001)",
  updateSurface: "oklch(0.173042 0 0)",
  accentSurface: "oklch(0.239292 0 0)",
  accentSurfaceForeground: "oklch(0.730784 0.142312 147.99)",
  messageSurface: "oklch(0.173042 0 0)",
  messageForeground: "oklch(0.946105 0 0)",
  messageAction: "oklch(0.717327 0.152224 251.001)",
  messageActionForeground: "oklch(0 0 0)",
  messageActionHover: "oklch(0.717327 0.152224 251.001)",
  codeBackground: "oklch(0.173042 0 0)",
  codeForeground: "oklch(0.946105 0 0)",
  sidebar: "oklch(0 0 0)",
  sidebarForeground: "oklch(0.946105 0 0)",
  sidebarMutedForeground: "oklch(0.709 0 0)",
  sidebarControlSurface: "oklch(0.173042 0 0)",
  sidebarRowHover: "oklch(0.173042 0 0)",
  sidebarRowActive: "oklch(0.239292 0 0)",
  sidebarRowSelected: "oklch(0.239292 0 0)",
  sidebarBorder: "oklch(0.239292 0 0)",
  terminalBackground: "oklch(0 0 0)",
  terminalForeground: "oklch(0.946105 0 0)",
  terminalCursor: "oklch(0.717327 0.152224 251.001)",
  terminalSelection: "oklch(0.239292 0 0)",
  terminalScrollbar: "oklch(0.513794 0 0)",
  terminalScrollbarHover: "oklch(0.709 0 0)",
};
