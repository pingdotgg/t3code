...
export const T3_CHAT_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    searchMatchBackground: "oklch(0.869588 0.06751 334.899)",
    searchMatchForeground: "oklch(0.325698 0.116116 325.037)",
    searchMatchActiveBackground: "oklch(0.591646 0.217985 0.584)",
    searchMatchActiveForeground: "oklch(1 0 0)",
  ...
  variants: {
    dark: {
      ...
      searchMatchBackground: "oklch(0.313674 0.030572 310.061)",
      searchMatchForeground: "oklch(0.980735 0.004092 301.426)",
      searchMatchActiveBackground: "oklch(0.460685 0.185347 4.099)",
      searchMatchActiveForeground: "oklch(0.901233 0.057189 343.694)",
...
export const GROVE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    searchMatchBackground: "oklch(0.891377 0.026164 164.929)",
    searchMatchForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchActiveBackground: "oklch(0.523295 0.112292 158.089)",
    searchMatchActiveForeground: "oklch(0.990339 0.008411 325.64)",
  ...
  variants: {
    dark: {
      ...
      searchMatchBackground: "oklch(0.464636 0.066083 158.72)",
      searchMatchForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchActiveBackground: "oklch(0.796228 0.133058 157.319)",
      searchMatchActiveForeground: "oklch(0.222003 0.03479 328.979)",
...
export const OCEAN_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    codeForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchBackground: "oklch(0.895373 0.023469 241.913)",
    searchMatchForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchActiveBackground: "oklch(0.536684 0.120219 247.01)",
    searchMatchActiveForeground: "oklch(0.990339 0.008411 325.64)",
  ...
  variants: {
    dark: {
      ...
      codeForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchBackground: "oklch(0.439946 0.0561 243.479)",
      searchMatchForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchActiveBackground: "oklch(0.758933 0.105833 241.548)",
      searchMatchActiveForeground: "oklch(0.222003 0.03479 328.979)",
...
export const EMBER_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    codeForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchBackground: "oklch(0.899296 0.022939 49.163)",
    searchMatchForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchActiveBackground: "oklch(0.552831 0.129438 44.656)",
    searchMatchActiveForeground: "oklch(0.990339 0.008411 325.64)",
  ...
  variants: {
    dark: {
      ...
      codeForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchBackground: "oklch(0.442681 0.0608 50.795)",
      searchMatchForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchActiveBackground: "oklch(0.762174 0.124117 52.082)",
      searchMatchActiveForeground: "oklch(0.222003 0.03479 328.979)",
...
export const IRIS_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    codeForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchBackground: "oklch(0.897143 0.028558 299.758)",
    searchMatchForeground: "oklch(0.222003 0.03479 328.979)",
    searchMatchActiveBackground: "oklch(0.525348 0.15373 294.176)",
    searchMatchActiveForeground: "oklch(0.990339 0.008411 325.64)",
  ...
  variants: {
    dark: {
      ...
      codeForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchBackground: "oklch(0.395417 0.085554 294.182)",
      searchMatchForeground: "oklch(0.990339 0.008411 325.64)",
      searchMatchActiveBackground: "oklch(0.671712 0.169136 293.929)",
      searchMatchActiveForeground: "oklch(0.222003 0.03479 328.979)",
