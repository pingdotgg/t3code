...
import { ServerSetProviderOptionsInput } from "./server";
...
export const WS_METHODS = {
  ...
  serverSetProviderOptions: "server.setProviderOptions",
} as const;
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverSetProviderOptions, ServerSetProviderOptionsInput),
]);
