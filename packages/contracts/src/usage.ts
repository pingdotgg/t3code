 ...
 * `~/.grok/sessions/**\/updates.jsonl`, `~/.copilot`) rather than relying on T3
 ...
 *
 * v5 adds `grok` and `copilot` to {@link UsageProviderKind}; v4 Claude/Codex
...
export const UsageProviderKind = Schema.Literals(["claude", "codex", "copilot", "grok"]);
