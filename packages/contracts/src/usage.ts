 ...
 *
 * v5/v6 add providers and optional source attribution; v7 adds optional
 * project attribution to buckets. v4 Claude/Codex buckets remain valid, so
...
export const USAGE_PROJECT_ATTRIBUTION_SINCE = 7 as const;
...
export const UsageBucket = Schema.Struct({
   ...
   * source carries no working directory (Grok, Cursor, OpenCode, Antigravity,
   * and summaries from servers predating this field).
   */
