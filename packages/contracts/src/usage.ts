 ...
 * `~/.grok/sessions/**\/updates.jsonl`, and OpenCode's
 * `$XDG_DATA_HOME/opencode/opencode.db`) rather than relying on T3 Code's own
 ...
 *
 * v5 added `grok` and v6 adds `opencode` to {@link UsageProviderKind}; v4
