...
export const HarnessSessionId = makeEntityId("HarnessSessionId");
export type HarnessSessionId = typeof HarnessSessionId.Type;
export const HarnessProfileId = makeEntityId("HarnessProfileId");
export type HarnessProfileId = typeof HarnessProfileId.Type;
export const HarnessConnectorId = makeEntityId("HarnessConnectorId");
export type HarnessConnectorId = typeof HarnessConnectorId.Type;
