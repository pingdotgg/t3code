...
export const ProgramAttemptId = makeEntityId("ProgramAttemptId");
export type ProgramAttemptId = typeof ProgramAttemptId.Type;
export const ProgramAttemptRequestId = makeEntityId("ProgramAttemptRequestId");
export type ProgramAttemptRequestId = typeof ProgramAttemptRequestId.Type;
