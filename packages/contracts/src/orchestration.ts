import { ThreadGoal, ThreadGoalSetInput } from "./threadGoal.ts";
...
export const ThreadGoalClearRequestedPayload = Schema.Struct({ threadId: ThreadId });
