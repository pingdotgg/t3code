...
export interface EnvironmentApi {
  ...
  vcs: {
    ...
    worktreeStoragePreview: (
      input: WorktreeStoragePreviewInput,
    ) => Promise<WorktreeStoragePreviewResult>;
    cleanupWorktrees: (input: WorktreeCleanupInput) => Promise<WorktreeCleanupResult>;
