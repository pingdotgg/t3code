...
> = {
  ...
  // No kimi aliases: Kimi model slugs come from ACP discovery and are sent
  // back verbatim via session/set_model — rewriting them here would produce
  // ids the agent never advertised.
  [KIMI_DRIVER_KIND]: {},
