...
export const AntigravitySettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("antigravity-acp-server").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Antigravity ACP server binary.",
        providerSettingsForm: {
          placeholder: "antigravity-acp-server",
          clearWhenEmpty: "omit",
        },
      }),
    ),
    geminiHome: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "Gemini home directory",
        description: "Optional custom GEMINI_HOME directory.",
        providerSettingsForm: {
          placeholder: "~/.gemini",
          clearWhenEmpty: "omit",
        },
...
const AntigravitySettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(TrimmedString),
  geminiHome: Schema.optionalKey(TrimmedString),
  customModels: Schema.optionalKey(Schema.Array(Schema.String)),
});
