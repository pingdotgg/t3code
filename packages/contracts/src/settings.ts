...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // macOS desktop only: pressing both Command keys together captures the
  // frontmost window and attaches it to the current thread's composer.
  // Browser clients and other platforms ignore it.
  screenshotHotkey: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  screenshotHotkey: Schema.optionalKey(Schema.Boolean),
