...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Keep explicit inheritance separate from mode overrides so older clients
  // can ignore this field and still decode their client settings.
  sidebarProjectGroupingInheritance: Schema.Record(TrimmedNonEmptyString, Schema.Boolean).pipe(
    Schema.withDecodingDefault(Effect.succeed({})),
  ),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarProjectGroupingInheritance: Schema.optionalKey(
