...
export const ClientSettingsSchema = Schema.Struct({
  ...
  sidebarProjectListEnabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarProjectListEnabled: Schema.optionalKey(Schema.Boolean),
