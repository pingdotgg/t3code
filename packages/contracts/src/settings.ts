...
export const ClientSettingsSchema = Schema.Struct({
  ...
  compactSidebarThreadRows: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  compactSidebarThreadRows: Schema.optionalKey(Schema.Boolean),
