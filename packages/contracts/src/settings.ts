...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Desktop-only: hold an OS sleep-prevention assertion while a locally
  // hosted agent has a running turn. Ignored by web and mobile clients.
  caffeinateWhileAgentsRunning: Schema.Boolean.pipe(
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  caffeinateWhileAgentsRunning: Schema.optionalKey(Schema.Boolean),
