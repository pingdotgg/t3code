...
export const DevinSettings = makeProviderSettingsSchema(
  {
    ...
    configPath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Config path",
        description: "Absolute path to a Devin configuration file.",
        providerSettingsForm: { placeholder: "/absolute/path/devin.json", clearWhenEmpty: "omit" },
      }),
    ),
    agentType: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Agent type",
        description: "Optional agent type passed to Devin.",
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional CLI arguments passed to Devin on session start.",
        providerSettingsForm: { placeholder: "--some-flag", clearWhenEmpty: "omit" },
      }),
    ),
    customModels: Schema.Array(Schema.String).pipe(
      Schema.withDecodingDefault(Effect.succeed([])),
