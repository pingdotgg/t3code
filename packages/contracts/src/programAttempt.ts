...
export const ProgramAttemptLaunchInput = Schema.Struct({
  ...
  candidateId: Schema.optional(TrimmedNonEmptyString),
  reviewId: Schema.optional(TrimmedNonEmptyString),
  reviewKind: Schema.optional(Schema.Literals(["broad", "focused"])),
  projectId: ProjectId,
...
export const ProgramAttemptSnapshot = Schema.Struct({
  ...
  attemptKind: Schema.NullOr(Schema.Literals(["task", "review"])),
  candidateId: Schema.NullOr(TrimmedNonEmptyString),
  reviewId: Schema.NullOr(TrimmedNonEmptyString),
  reviewKind: Schema.NullOr(Schema.Literals(["broad", "focused"])),
  title: TrimmedNonEmptyString,
  checkout: PreparedWorktreeCheckout,
  projectId: ProjectId,
  threadId: ThreadId,
