...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands sectionName on thread.meta.update and returns it on
      thread snapshots. Missing means clients must not offer section actions. */
  threadSections: Schema.optionalKey(Schema.Boolean),
