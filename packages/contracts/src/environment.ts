...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server accepts `board.open` in persisted keybinding rules. Absent on
      older servers, so clients provide the default locally but hide customization. */
  boardKeybinding: Schema.optionalKey(Schema.Boolean),
