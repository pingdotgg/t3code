...
export const PICKER_KEYBINDING_COMMANDS = ["picker.previous", "picker.next"] as const;
export type PickerKeybindingCommand = (typeof PICKER_KEYBINDING_COMMANDS)[number];
