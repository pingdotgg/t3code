 ...
 */
// ponytail: the winner's descriptor is discarded and refetched by authorizeBearer;
// pass it through if the extra round trip ever shows up in connect latency.
