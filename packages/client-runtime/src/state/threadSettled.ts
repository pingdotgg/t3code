...
/**
 * Client-side affordance guard for explicit settlement. The server owns and
 * persists the actual lifecycle transition and enforces the same invariants.
 */
 ...
 * the persisted settlement lifecycle.
 */
