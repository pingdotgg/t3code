...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    endMonitor: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:end-monitor",
      execute: (input: EndThreadMonitorInput) => endThreadMonitor(input),
      scheduler,
      concurrency,
    }),
