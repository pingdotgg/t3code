...
import {
  ...
  type SwitchThreadProviderAccountInput,
...
export type {
  ...
  SwitchThreadProviderAccountInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    switchProviderAccount: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:switch-provider-account",
      execute: (input: SwitchThreadProviderAccountInput) => switchThreadProviderAccount(input),
      scheduler,
      concurrency,
    }),
