...
import {
  ...
  type RequestThreadHandoffInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    requestHandoff: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:request-handoff",
      execute: (input: RequestThreadHandoffInput) => requestThreadHandoff(input),
      scheduler,
      concurrency,
    }),
    ...
    acceptHandoff: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:accept-handoff",
      execute: (input: AcceptThreadHandoffInput) => acceptThreadHandoff(input),
      scheduler,
      concurrency,
    }),
  };
