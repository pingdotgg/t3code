...
import {
  ...
  type SetThreadExecutorModelInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setExecutorModel: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-executor-model",
      execute: (input: SetThreadExecutorModelInput) => setThreadExecutorModel(input),
      scheduler,
      concurrency,
    }),
