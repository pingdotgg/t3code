...
export function createProjectEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    projectCapabilities: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:providers:project-capabilities",
      tag: WS_METHODS.providersProjectCapabilities,
      staleTimeMs: 30_000,
      idleTtlMs: 5 * 60_000,
    }),
