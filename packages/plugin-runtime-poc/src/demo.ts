...
const variants: ReadonlyArray<readonly [string, PluginRuntimeFactory]> = [
  ["effect-scope", createEffectScopeRuntime],
  ["cordis", createCordisRuntime],
  ["pure-reconciler", createPureRuntime],
];
...
for (const [name, createRuntime] of variants) {
