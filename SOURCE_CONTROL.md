...
- Generated from `upstream/main` `cabc93bad305c14e1b6919c6631deca153032f9f` with starting branch HEAD `ef3cc00f7e3ffe6ed106fa5cfa157e00c1cb02e6`; the merge created local merge commit `ff137cec2cbf2d7d8bf7d79456a748c1ec00b94b`.
- Shared refs at merge time: `origin/main` `530239fc627659cb7900c69582bf520ed172555e`, local `main` `530239fc627659cb7900c69582bf520ed172555e`.
- Effective branch delta after the merge: `67 ahead / 0 behind upstream/main`, `71 ahead / 416 behind origin/main`, `71 ahead / 416 behind local main`; current working-tree fork diff size is `57 files changed, 15276 insertions(+), 398 deletions(-)` against the `upstream/main` tree.
- Merge note: upstream commits `6d35a87c55b4ed6f0507c1c45591c838b310d58b9`, `32d17d3dbba9af40589c37a872f4a079bc5ee84f`, `5cda8156222d0c97b101ce85be6d72f7258563cd`, and `cabc93bad305c14e1b6919c6631deca153032f9f` brought Electron dev-launcher fixes, the adaptive iPad/mobile workspace split view with native keyboard/header controls, EAS native-pod patch compilation, and elevated liquid-glass composer styling. Git merged these changes without conflict markers or manual conflict resolutions. The incoming work did not touch the Version Control source files or right-panel source-control glue directly, so the branch preserved its source-control/sidebar glue, right-panel surface gating, thread metadata routing, draft metadata updates, structured/stale errors, hook lifetime sequencing, status-derived default branch, stale branch path filtering, rename fallback suppression, VCS watcher retention, cwd-scoped enrichment, selected-file commit/merge hardening, stable stash keys, source-control cache refreshes, right-panel add-surface action refactor, remote-name-aware branch parsing, and the behavior notes in this file. No Version Control panel customization was retired, no upstream implementation made this branch's panel work obsolete, and no new source-control fork customization was introduced by the merge.
